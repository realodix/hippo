...
final class Repository
{
     ...
     * @param array<string> $newBlockHashes New hashes
     */
    public function update(string $filePath, array $newBlockHashes = []): void
    {
        $this->set($filePath, [
            'file_hash' => hash_file(self::HASH_ALGO, $filePath),
            'blocks' => $newBlockHashes,
        ]);
    }
