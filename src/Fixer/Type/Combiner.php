...
final class Combiner
{
     ...
     * @param string $domainPattern The regex pattern to extract the domain part
     * @return \Realodix\Hippo\Fixer\ValueObject\DomainSection An object containing the extracted parts of the filter
     */
     ...
     *
     * @param \Realodix\Hippo\Fixer\ValueObject\DomainSection $currentLine The analysis of the current filter rule
     * @param \Realodix\Hippo\Fixer\ValueObject\DomainSection $nextLine The analysis of the next filter rule
     * @param string $separator The separator character used between domains (`,` or `|`)
